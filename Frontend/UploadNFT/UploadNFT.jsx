...
import formStyle from "../AccountPage/Form/Form.module.css" // take the form style from account page
...
const UploadNFT = ({ uploadToIPFS, createNFT }) => {
  ...
  return (
    <div className={Style.upload}>
      <DropZone
        // use vague names for the props for multiple use
      ...
      <div className={Style.upload_box}>
        <div className={formStyle.Form_box_input}>
          ...
          <input
            ...
            //^^ 'e' is event, can be a click, data-entry, etc.
          />
        </div>
